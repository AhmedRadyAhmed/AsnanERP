...
public partial class Convert_Date : System.Web.UI.Page
{
        private HttpContext cur;
		private const int startGreg=1900;
		private const int endGreg=2100;
        private string[] allFormats = { "yyyy/MM/dd", "yyyy/M/d", "dd/MM/yyyy", "MM/dd/yyyy", "d/M/yyyy", "dd/M/yyyy", "d/MM/yyyy", "yyyy-MM-dd", "yyyy-M-d", "dd-MM-yyyy", "d-M-yyyy", "dd-M-yyyy", "d-MM-yyyy", "yyyy MM dd", "yyyy M d", "dd MM yyyy", "d M yyyy", "dd M yyyy", "d MM yyyy" };
    ...
    {
        GegDate.Text = HijriToGreg(Hijridate.Text, "MM/dd/yyyy");
    }
    protected void BtnConvert0_Click(object sender, EventArgs e)
    {
        GegDate.Text = HijriToGreg(Hijridate.Text, "MM/dd/yyyy");
    }
    protected void BtnConvert0_Click1(object sender, EventArgs e)
    {

        GegDate.Text = GregToHijri(Hijridate.Text, "dd/MM/yyyy");
    }
}