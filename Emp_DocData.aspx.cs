...
public partial class Emp_DocData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        mycl.Begin();
        if (Session["Emp_doc"] != null)
        {
            string sl = Session["Emp_doc"].ToString();
   ...
   protected void Grid_RowDataBound(object sender, GridViewRowEventArgs e)
    ...
    protected void BtnDeleteGrid_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            mycl.Execute("Delete from Emp_Documents where Serial=" + x);
            string sl = mycl.InsertTbLog("Emp_Documents File Delete", "Delete", "Emp_Documents", "Emp_Documents.aspx", x.ToString());
            mycl.Execute(sl);
            mycl.mytrancommit();
            Grid.DataBind();
            LblCount.Text = Grid.Rows.Count.ToString();
    ...
    protected void BtnPdf_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton b = (ImageButton)sender;
        GridViewRow r = (GridViewRow)b.NamingContainer;
        string fname = mycl.Exec_scalar("select MyFil_name from Emp_Documents where Serial=" + r.Cells[0].Text);
