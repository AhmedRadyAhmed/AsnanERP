...
public partial class Customer_Docdata : System.Web.UI.Page
{
   ...
   protected void Grid_RowDataBound(object sender, GridViewRowEventArgs e)
    ...
    protected void BtnDeleteGrid_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            string sl = mycl.InsertTbLog("Customer_Documents File Delete", "Delete", "Customer_Documents", "Customer_Documents.aspx", x.ToString());
            mycl.Execute(sl);
            mycl.mytrancommit();
            Grid.DataBind();
            LblCount.Text = Grid.Rows.Count.ToString();
    ...
    protected void BtnPdf_Click(object sender, ImageClickEventArgs e)
    {
        ...
        cstext2.Append("window.open('" + "Customer Files/" + fname + "','_newtab')");
