<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EmpVacations_Search.aspx.cs" Inherits="EmpVacations_Search" %>
...
<div style=" background-color: #E8F4FF;">
    ...
    <div style="text-align: center; font-weight: 700; height: 22px;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Serial, EmpCode, Empname_en, Empname_Ar, VisaType, VisaDateFrom, VisaDateTo, ActDateFrom, ActDateTo, Notes, InsertBy FROM VEmpVacations">
        </asp:SqlDataSource>
    ...
    <tr>
        ...
        <asp:GridView ID="Grid" runat="server"  Width="100%" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="VisaType" HeaderText="VisaType" 
                    SortExpression="VisaType" />
                <asp:BoundField DataField="VisaDateFrom" HeaderText="VisaDateFrom" 
                    SortExpression="VisaDateFrom" DataFormatString="{0:MM/dd/yyyy}"/>
                <asp:BoundField DataField="VisaDateTo" HeaderText="VisaDateTo" 
                    SortExpression="VisaDateTo" DataFormatString="{0:MM/dd/yyyy}" />
                <asp:BoundField DataField="ActDateFrom" HeaderText="ActDateFrom" 
                    SortExpression="ActDateFrom" DataFormatString="{0:MM/dd/yyyy}" />
                <asp:BoundField DataField="ActDateTo" HeaderText="ActDateTo" 
                    SortExpression="ActDateTo" DataFormatString="{0:MM/dd/yyyy}" />
                     ...
                     <asp:TemplateField HeaderText="Edit">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperReply" runat="server" 
                                    NavigateUrl='<%# Eval("Serial", "~/EmpVacations.aspx?Serial={0}") %>' 
